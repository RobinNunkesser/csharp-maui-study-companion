...
namespace Plugin.Calendars
{
    ...
    public partial class CalendarsImplementation : ICalendars
    {
        ...
        public partial async Task<IList<Calendar>> GetCalendarsAsync()
        {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task<Calendar?> GetCalendarByIdAsync(string externalId)
        {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task<IList<CalendarEvent>> GetEventsAsync(Calendar calendar, DateTime start, DateTime end)
        {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task<CalendarEvent?> GetEventByIdAsync(string externalId)
        {
            if (string.IsNullOrWhiteSpace(externalId))
            {
                return null;
        ...
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task AddOrUpdateCalendarAsync(Calendar calendar)
        {
        ...
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task AddOrUpdateEventAsync(Calendar calendar, CalendarEvent calendarEvent)
        {
            await RequestCalendarAccess().ConfigureAwait(false);
        ...
        /// <exception cref="System.InvalidOperationException">Editing recurring events is not supported</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task AddEventReminderAsync(CalendarEvent calendarEvent, CalendarEventReminder reminder)
        {
            // TODO: Remove redundant null check after migrating to .net6
            if (calendarEvent.ExternalID == null || string.IsNullOrEmpty(calendarEvent.ExternalID))
            {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task<bool> DeleteCalendarAsync(Calendar calendar)
        {
            // TODO: Remove redundant null check after migrating to .net6
            if (calendar.ExternalID == null || string.IsNullOrEmpty(calendar.ExternalID))
            {
        ...
        /// <exception cref="System.InvalidOperationException">Editing recurring events is not supported</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial async Task<bool> DeleteEventAsync(Calendar calendar, CalendarEvent calendarEvent)
        {
            // TODO: Remove redundant null check after migrating to .net6
            if (calendar.ExternalID == null || string.IsNullOrEmpty(calendar.ExternalID)
