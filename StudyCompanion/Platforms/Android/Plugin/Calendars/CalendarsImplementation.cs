...
namespace Plugin.Calendars
{
    ...
    public partial class CalendarsImplementation : ICalendars
    {
        ...
        public partial Task<IList<Calendar>> GetCalendarsAsync() => Task.Run(() =>
        {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public partial Task<CalendarEvent?> GetEventByIdAsync(string externalId) => Task.Run(() => GetEventById(externalId));
